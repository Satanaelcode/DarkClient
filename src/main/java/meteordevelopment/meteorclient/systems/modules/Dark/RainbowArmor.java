...
public class RainbowArmor extends Module {
    ...
    public RainbowArmor() {
        super(Categories.Dark, "rainbow-armor", "Gives you rainbow leather armor.");
    }
    ...
    private void onTick(TickEvent.Post event) {
        ...
        if (mode.get() == Mode.Math) {
            ...
            textColor = DarkUtils.rainbowColors(current);
            if (DarkUtils.rainbowColors(textColor) >= 18) current = 0;
            current++;
        }
