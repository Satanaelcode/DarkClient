...
public class ChatUtils {
    ...
    public static void init() {
        PREFIX = Text.literal("")
            ...
            .append("[")
            .append(Text.literal("Dark").setStyle(Style.EMPTY.withColor(new TextColor(Color.DARK_GRAY.getPacked()))))
            .append("] ");
    }
    ...
    public static void sendPlayerMsg(String message) {
        ...
        if (message.startsWith("command/")) mc.player.networkHandler.sendCommand(message.substring(1));
